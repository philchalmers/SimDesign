...
Finally, the new `subDesign` information is row-bound to the original expanded version using `rbind()` with `keep.IDs = TRUE` (the default), though telling the scheduler to only evaluate these new rows in the `#SBATCH --array` specification. 
