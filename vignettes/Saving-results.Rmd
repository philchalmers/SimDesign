...
After the simulation is complete, these results can be extracted using the `extract_results()` function. For example,
...
```{r include=FALSE}
SimDesign::SimClean("SIMDESIGN_CRASHFILE_SEEDS.rds")
```
