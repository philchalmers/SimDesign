...
Final <- runSimulation(design = Design, replications = 1000, verbose = FALSE,
...
```{r cache=TRUE, eval=FALSE}
res <- runSimulation(Design, replications = 1000, generate=Generate, analyse=Analyse, summarise=Summarise)
