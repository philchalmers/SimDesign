...
#' results corresponding to the \code{design} object will be stored to a suitable
#' sub-directory as individual .rds files. While one could use \code{\link{readRDS}} directly,
#' this is a conviencience function to read the rows in automatically given the returned object
...
#'   was used
#'
#' @param which a numeric vector indicating which rows should be read in
#'
