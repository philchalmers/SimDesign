...
Notice that the fractional factor design has many fewer condition than the fully crossed version above. However, despite this reduced number of conditions valid main and two-way interaction effects are still estimable.
