...
test_that('SimDesign', {
    ...
    mysim <- function(condition, generate_extras){
    ...
    mycompute <- function(dat, parameters, condition, generate_extras){
    ...
    mycollect <- function(results, parameters_list, condition, generate_extras){
