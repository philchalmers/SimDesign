...
estimators for variance ratio tests. Statistical tests are organized by
columns and the unique design conditions are organized by rows. See
[`BF_sim_alternative`](http://philchalmers.github.io/SimDesign/reference/BF_sim_alternative.md)
for an alternative form of the same simulation. Code for this simulation
is available on the Github wiki
