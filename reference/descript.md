...
#> 3 8     disp     14  353.  350.  67.8 0.453 -1.26 276.  302.   350.  390   472 
#> 
#> ------------------------------------------------------------
#>  
#> VARIABLE: hp
...
#> 3 6     automatic mpg      12  15.0  15.1 2.77  -0.284  -0.964  10.4  14.0  15.2
#> 4 6     manual    mpg       8  28.1  28.1 4.48  -0.208  -1.66   21.4  25.2  28.8
#> 5 8     automatic mpg       3  20.6  20.6 0.751 -0.385  -2.33   19.7  20.4  21  
...
#> 3 6     auto… disp     12 358.  354.  71.8   0.303 -1.51 276.  297.  355    410 
#> 4 6     manu… disp      8  93.6  93.6 20.5   0.276 -1.89  71.1  78.0  87.0  111.
#> 5 8     auto… disp      3 155   155    8.66 -0.385 -2.33 145   152.  160    160 
#> 6 8     manu… disp      2 326   326   35.4   0     -2.75 301   314.  326    338.
#> # ℹ 1 more variable: max <dbl>
#> 
#> ------------------------------------------------------------
#>  
...
#> 3 6     automatic hp       12 194.  194.  33.4   0.279  -1.44   150 175   180  
#> 4 6     manual    hp        8  81.9  81.9 22.7   0.137  -1.81    52  65.8  78.5
#> 5 8     automatic hp        3 132.  132.  37.5   0.385  -2.33   110 110   110  
...
#> 3 6     automatic drat     12  3.12  3.10 0.230  1.17    1.64   2.76  3.05  3.08
#> 4 6     manual    drat      8  4.18  4.18 0.364  0.828  -0.472  3.77  4.02  4.10
#> 5 8     automatic drat      3  3.81  3.81 0.162 -0.385  -2.33   3.62  3.76  3.9 
...
#> 3 6     automat… wt       12  4.10  4.04 0.768  8.54e- 1 -1.14  3.44  3.56  3.81
#> 4 6     manual   wt        8  2.04  2.04 0.409  3.49e- 1 -1.15  1.51  1.78  2.04
#> 5 8     automat… wt        3  2.76  2.76 0.128 -1.15e- 1 -2.33  2.62  2.70  2.77
#> 6 8     manual   wt        2  3.37  3.37 0.283 -1.15e-15 -2.75  3.17  3.27  3.37
#> # ℹ 2 more variables: P75 <dbl>, max <dbl>
#> 
#> ------------------------------------------------------------
#>  
...
#> 3 6     autom… qsec     12  17.1  17.2 0.802  -9.33e- 1 -0.338  15.4  17.0  17.4
#> 4 6     manual qsec      8  18.4  18.4 1.13   -4.28e- 1 -1.39   16.7  18.1  18.6
#> 5 8     autom… qsec      3  16.3  16.3 0.769  -1.68e- 1 -2.33   15.5  16.0  16.5
#> 6 8     manual qsec      2  14.6  14.6 0.0707 -1.89e-14 -2.75   14.5  14.5  14.6
#> # ℹ 2 more variables: P75 <dbl>, max <dbl>
#> 
#> ------------------------------------------------------------
#>  
...
#> 3 6     automatic gear     12  3     3    0     NaN     NaN        3   3     3  
#> 4 6     manual    gear      8  4.25  4.25 0.463   0.945  -1.21     4   4     4  
#> 5 8     automatic gear      3  4.33  4.33 0.577   0.385  -2.33     4   4     4  
...
#> 3 6     auto… carb     12  3.08  3.1  0.900 -0.141 -1.85     2   2     3       4
#> 4 6     manu… carb      8  1.5   1.5  0.535  0     -2.23     1   1     1.5     2
#> 5 8     auto… carb      3  4.67  4.67 1.15   0.385 -2.33     4   4     4       5
